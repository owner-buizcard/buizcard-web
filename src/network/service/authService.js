...
export async function loginWithLinkedin(data){
    window.location.href = 'https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=864hy6jn3uyw75&redirect_uri=https://x9a0br47t1.execute-api.us-east-1.amazonaws.com/dev/auth/callback/linkedin&state=foobar&scope=profile%20openid%20email';
}
