...
export async function verifyOTP(data){
    return await axiosClient.post('/auth/otp/verify', data);
}
...
export async function loginWithLinkedin(data){
    window.location.href = `https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=7782mi1w2h629z&redirect_uri=${BASE_URL}/auth/callback/linkedin&state=dev&scope=profile%20openid%20email`;
}
...
export async function verifyEmail(){
    return await axiosClient.put('/verify-email');
}